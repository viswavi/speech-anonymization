"""
This file contains a very simple TDNN module to use for sex/gender classification
...
# Daniel's comment: currently a direct copy from speechbrain/templates/speaker_id/custom_model.py
