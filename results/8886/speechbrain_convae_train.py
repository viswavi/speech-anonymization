...
class SexAnonymizationTraining(sb.core.Brain):
    ...
    def compute_objectives(self, predictions, batch, stage):
        ...
        if stage != sb.Stage.TRAIN:
            ...
            sex_logits_extern, score, index = self.external_classifier_model.classify_batch_feats(recon_speech_feats, wav_lens)
            breakpoint()

            #sex_logits_extern_orig, score_orig, index_orig = self.external_classifier_model.classify_batch_feats(feats, wav_lens)
    ...
    def external_classifier(self):
        ...
        classifier = EncoderClassifier.from_hparams(
            source="/home/ec2-user/speech-anonymization/results/gender_classifier/1230/save/",
