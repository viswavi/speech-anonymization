...
class SexAnonymizationTraining(sb.core.Brain):
    ...
    def compute_objectives(self, predictions, batch, stage):
        ...
        confusion_loss = self.hparams.loss_confusion(sex_logits, (torch.ones(sex_logits.shape)*(-0.6931)).to(self.device))
        ...
        if self.hparams.model_type == "endtoend":
            if self.hparams.recon_loss_weight == 0.0 and self.hparams.utility_loss_weight == 0.0:
                ...
                loss = (
                    ...
                    - self.hparams.confusion_loss_weight * confusion_loss
        ...
        if stage != sb.Stage.TRAIN:
            ...
            if stage == sb.Stage.VALID:
                ...
                self.wer_metric2.append(ids, o_predicted_words, target_words)
                ...
                print("Orig WER summary = ")
                print(self.wer_metric2.summarize("error_rate"))
    ...
    def fit_batch(self, batch):
        ...
        if self.hparams.epoch_counter.current%2==0:#self.step%200==0:
            #print("Jointly train sex + utility............")
            self.hparams.recon_loss_weight = 0.0
            self.hparams.sex_loss_weight = 0.8
            self.hparams.utility_loss_weight = 0.2
            self.hparams.confusion_loss_weight = 0.0
            ...
            self.hparams.recon_loss_weight = 0.0
            self.hparams.sex_loss_weight = 0.5
            self.hparams.utility_loss_weight = 0.0
    ...
    def on_stage_start(self, stage, epoch):
        ...
        if stage != sb.Stage.TRAIN:
            ...
            if stage == sb.Stage.TEST:
                ...
                self.wer_metric2 = self.hparams.error_rate_computer()
